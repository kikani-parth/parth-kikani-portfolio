...
const socialLinks = [
  {
    href: 'https://github.com/kikani-parth',
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: 'https://www.linkedin.com/in/kikani-parth/',
    icon: (
      <svg
        width="24"
        height="24"
    ...
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          <h2 className="headline-2 lg:max-w-[12ch]">Let&apos;s talk</h2>
